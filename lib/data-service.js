...
class DataService {
  ...
  async select(scope) {
    ...
    const skip = pagination.skip ? pagination.skip : (pagination.page - 1) * pagination.limit;
  ...
  getPagination(scope) {
    ...
    if (!pagination.page && pagination.skip === undefined) {
      pagination.page = this.config.firstPageIndex;
    }
